...
# Appended to every slot prompt so internal attribute/module jargon never appears as on-image copy.
_SHOPPER_FACING_COPY_SUFFIX = (
    "On-image text must be shopper-facing only. Do not write A+, A+ Content, A+ Features, "
    "A+ Care, Enhanced Brand Content, EBC, PDP, IMAGE, A_PLUS, or other internal/ops labels "
    "anywhere on the image. Use normal product titles (e.g. Features, Care instructions)."
)
