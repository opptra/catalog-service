...
# Topics that inform image generation.
_IMAGE_TOPICS = ("gallery_images",)
...
def image_brief(category_intelligence: dict[str, Any]) -> dict[str, Any]:
    """Concise brief for image generation (gallery/image guidance)."""
    return _build(category_intelligence, list(_IMAGE_TOPICS))
